...
-- Dumping structure for table classicmodels.customergojek
CREATE TABLE IF NOT EXISTS `customergojek` (
  `id_cust` decimal(10,2) NOT NULL,
  `nama_cust` varchar(70) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `notel_cust` decimal(10,2) NOT NULL,
  PRIMARY KEY (`id_cust`),
  KEY `id_cust` (`id_cust`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table classicmodels.customergojek: ~0 rows (approximately)
DELETE FROM `customergojek`;
...
-- Dumping structure for table classicmodels.customers_copy
CREATE TABLE IF NOT EXISTS `customers_copy` (
  `customerNumber` int NOT NULL,
  `customerName` varchar(50) NOT NULL,
  `contactLastName` varchar(50) NOT NULL,
  `contactFirstName` varchar(50) NOT NULL,
...
-- Dumping data for table classicmodels.customers_copy: ~84 rows (approximately)
DELETE FROM `customers_copy`;

-- Dumping structure for table classicmodels.drivergojek
CREATE TABLE IF NOT EXISTS `drivergojek` (
  `id_driv` decimal(10,2) NOT NULL,
  `nama_driv` varchar(70) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `notelp_driv` decimal(10,2) NOT NULL,
  `kendaraan` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `platKen` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  PRIMARY KEY (`id_driv`),
  KEY `id_driv` (`id_driv`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table classicmodels.drivergojek: ~0 rows (approximately)
DELETE FROM `drivergojek`;
...
INSERT INTO `employees` (`employeeNumber`, `lastName`, `firstName`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`) VALUES
	(1002, 'Murphy', 'Diane', 'x5800', 'dmurphy@classicmodelcars.com', '1', NULL, 'RAJA Sales'),
...
-- Dumping structure for table classicmodels.ordergojek
CREATE TABLE IF NOT EXISTS `ordergojek` (
  `id_order` decimal(10,2) NOT NULL,
  `id_cust` decimal(10,2) NOT NULL,
  `id_driv` decimal(10,2) NOT NULL,
  `tgl_order` varchar(70) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `total_pay` decimal(10,2) NOT NULL,
  `jenis_pay` varchar(70) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `lokasi_awal` varchar(70) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `lokasi_tujuan` varchar(70) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `jarak` varchar(70) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `waktu_perjalanan` varchar(70) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  PRIMARY KEY (`id_order`),
  KEY `id_cust` (`id_cust`),
  KEY `id_driv` (`id_driv`),
  CONSTRAINT `id_cust` FOREIGN KEY (`id_cust`) REFERENCES `customergojek` (`id_cust`),
  CONSTRAINT `id_driv` FOREIGN KEY (`id_driv`) REFERENCES `drivergojek` (`id_driv`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table classicmodels.ordergojek: ~0 rows (approximately)
DELETE FROM `ordergojek`;
...
-- Dumping structure for table classicmodels.pegawai
CREATE TABLE IF NOT EXISTS `pegawai` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nama` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `umur` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `alamat` varchar(300) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=latin1;

-- Dumping data for table classicmodels.pegawai: ~0 rows (approximately)
DELETE FROM `pegawai`;
INSERT INTO `pegawai` (`id`, `nama`, `umur`, `alamat`) VALUES
	(1, 'jamal', '43', 'Bogor Tengah'),
	(2, 'Mohamad Alif Ramdani', '26', 'Bogor'),
	(3, 'julfa', '43', 'Sulawesi Tengah'),
	(4, 'zahra', '43', 'Minang Tengah'),
	(5, 'mirna', '35', 'Cengkareng'),
	(6, 'bidin', '38', 'Ciremai'),
	(7, 'tahu', '241', 'adawa'),
	(8, 'rifqi', '24', 'awadawad'),
	(9, 'encep', '54', 'adaw ad'),
	(10, 'turu', '24', 'kdaodia dwioajdi aidma imdia omdoad iamdiao mwmd wim iamdoamda oim'),
	(11, 'kumar', '54', 'Bogor timur'),
	(12, 'ismail', '86', 'Bogor utara'),
	(13, 'subur', '45', 'Bogor barat'),
	(14, 'rehan', '23', 'Cimahi Timur'),
	(15, 'tukul', '43', 'Cimahi Barat'),
	(16, 'rahman', '22', 'Cimahi Utara'),
	(17, 'imron', '35', 'Cimahi Tengah'),
	(18, 'rohim', '32', 'Cimahi Selatan'),
	(19, 'kamir', '23', 'Cimahpar barat'),
	(20, 'usman', '24', 'Bandung barat');
...
INSERT INTO `products` (`productCode`, `productName`, `productLine`, `productScale`, `productVendor`, `productDescription`, `quantityInStock`, `buyPrice`, `MSRP`) VALUES
	...
	('S90_111', 'Yamaha Mio', 'Motorcycles', '1:90', 'Yamaha', 'Ini adalah product yamaha', 1000, 20000.00, 100.00),
	('S90_112', 'Yamaha Vixion', 'Motorcycles', '1:90', 'Yamaha', 'Ini adalah product yamaha', 1000, 20000.00, 100.00),
	('S90_113', 'Yamaha Felano', 'Motorcycles', '1:90', 'Yamaha', 'Ini adalah product yamaha', 1000, 20000.00, 100.00),
	('S90_114', 'Yamaha R15', 'Motorcycles', '1:90', 'Yamaha', 'Ini adalah product yamaha', 1000, 20000.00, 100.00),
	('S90_115', 'Yamaha Aerox', 'Motorcycles', '1:90', 'Yamaha', 'Ini adalah product yamaha', 1000, 20000.00, 100.00);

-- Dumping structure for table classicmodels.products_copu
CREATE TABLE IF NOT EXISTS `products_copu` (
...
-- Dumping data for table classicmodels.products_copu: ~0 rows (approximately)
DELETE FROM `products_copu`;

-- Dumping structure for table classicmodels.products_copy
...
-- Dumping data for table classicmodels.products_copy: ~120 rows (approximately)
DELETE FROM `products_copy`;
INSERT INTO `products_copy` (`productCode`, `productName`, `productLine`, `productScale`, `productVendor`, `productDescription`, `quantityInStock`, `buyPrice`, `MSRP`) VALUES
	('S80_111', 'Honda Brio', 'Mobil', '1:90', 'Honda', 'Ini adalah product Honda', 1000, 20000.00, 100.00),
	('S80_112', 'Honda Mobilio', 'Mobil', '1:90', 'Honda', 'Ini adalah product Honda', 1000, 20000.00, 100.00),
	('S80_113', 'Honda HRV', 'Mobil', '1:90', 'Honda', 'Ini adalah product Honda', 1000, 20000.00, 100.00),
	('S80_114', 'Honda CRV', 'Mobil', '1:90', 'Honda', 'Ini adalah product Honda', 1000, 20000.00, 100.00),
	('S80_115', 'Honda Civic', 'Mobil', '1:90', 'Honda', 'Ini adalah product Honda', 1000, 20000.00, 100.00),
	('S10_1678', '1969 Harley Davidson Ultimate Chopper', 'Motorcycles', '1:10', 'Min Lin Diecast', 'This replica features working kickstand, front suspension, gear-shift lever, footbrake lever, drive chain, wheels and steering. All parts are particularly delicate due to their precise scale and require special care and attention.', 7933, 48.81, 95.70),
	('S10_1949', '1952 Alpine Renault 1300', 'Classic Cars', '1:10', 'Classic Metal Creations', 'Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.', 7305, 98.58, 214.30),
	('S10_2016', '1996 Moto Guzzi 1100i', 'Motorcycles', '1:10', 'Highway 66 Mini Classics', 'Official Moto Guzzi logos and insignias, saddle bags located on side of motorcycle, detailed engine, working steering, working suspension, two leather seats, luggage rack, dual exhaust pipes, small saddle bag located on handle bars, two-tone paint with chrome accents, superior die-cast detail , rotating wheels , working kick stand, diecast metal with plastic parts and baked enamel finish.', 6625, 68.99, 118.94),
	('S10_4698', '2003 Harley-Davidson Eagle Drag Bike', 'Motorcycles', '1:10', 'Red Start Diecast', 'Model features, official Harley Davidson logos and insignias, detachable rear wheelie bar, heavy diecast metal with resin parts, authentic multi-color tampo-printed graphics, separate engine drive belts, free-turning front fork, rotating tires and rear racing slick, certificate of authenticity, detailed engine, display stand\r\n, precision diecast replica, baked enamel finish, 1:10 scale model, removable fender, seat and tank cover piece for displaying the superior detail of the v-twin engine', 5582, 91.02, 193.66),
